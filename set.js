...
global.caption = "Trevor @"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~MX0CwKRR#D3ZcI_A8X4mzbLJDesaRkHU0tqAVlxvnT1Ljlq-LuTE", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "263778779094", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "263778779094", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "Rivic t", // Input Yours custom...(Maintain font for Flow)
...
BOT_NAME: process.env.BOT_NAME || "Majurona", // Input Yours custom...(Maintain font for Flow)
